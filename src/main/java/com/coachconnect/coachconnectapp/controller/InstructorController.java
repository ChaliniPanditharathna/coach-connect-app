...
public class InstructorController {
	...
	public ResponseEntity<Instructor> getAllInstructors(@PathVariable("userId") long userId) {

		Optional<Instructor> instructor = instructorRepository.findInstructorByUserId(userId);
