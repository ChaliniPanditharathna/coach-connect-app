package com.coachconnect.coachconnectapp.security.jwt;
...
public class JwtUtils {
	...
	@Value("${coachconnect.app.jwtSecret}")
	private String jwtSecret;

	@Value("${coachconnect.app.jwtExpirationMs}")
	private int jwtExpirationMs;

	@Value("${coachconnect.app.jwtCookieName}")
